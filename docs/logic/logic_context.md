...
## 6. Governance & Research Logic
Governance metrics (BIP lifecycle, Mailing List proof) are isolated in a separate forensic pipeline.
*   **Logic**: Tracing document churn (Friction) and Social Proof (Mailing List mentions).
*   **Source**: `docs/logic/governance_data_logic.md`.
