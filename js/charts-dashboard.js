...
async function loadVitalSigns() {
    try {
        const res = await fetch(DATA_PATH_PREFIX + 'output/tracker/dashboard_vital_signs.json?t=' + Date.now());
...
async function loadSnapshots() {
    ...
    if (charts.snapshotWork) {
        try {
            const resWork = await fetch(DATA_PATH_PREFIX + 'output/tracker/stats_work_distribution.json?t=' + Date.now());
    ...
    if (charts.snapshotVolume) {
        try {
            const resVol = await fetch(DATA_PATH_PREFIX + 'output/tracker/stats_code_volume.json?t=' + Date.now());
    ...
    if (charts.snapshotStack) {
        try {
            const resStack = await fetch(DATA_PATH_PREFIX + 'output/tracker/stats_tech_stack.json?t=' + Date.now());
...
async function loadCategory() {
    try {
        const res = await fetch(DATA_PATH_PREFIX + 'output/tracker/stats_category_evolution.json?t=' + Date.now());
...
async function loadGrowth() {
    try {
        const res = await fetch(DATA_PATH_PREFIX + 'output/tracker/stats_contributor_growth.json?t=' + Date.now());
        const data = await res.json();
...
async function loadEngagementTiers() {
    try {
        const res = await fetch(DATA_PATH_PREFIX + 'output/tracker/stats_engagement_tiers.json?t=' + Date.now());
...
async function loadSocial() {
    try {
        const res = await fetch(DATA_PATH_PREFIX + 'output/tracker/stats_social_proof.json?t=' + Date.now());
        const data = await res.json();
        const filteredX = data.xAxis;
...
async function loadStory() {
    try {
        const resHM = await fetch(DATA_PATH_PREFIX + 'output/tracker/stats_heatmap.json?t=' + Date.now());
        ...
        const resW = await fetch(DATA_PATH_PREFIX + 'output/tracker/stats_weekend.json?t=' + Date.now());
