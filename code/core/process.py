...
class Config:
    ...
    MAINTAINERS_FILE = f"{CACHE_DIR}/maintainers_lookup.json"
    SPONSORS_FILE = f"{CACHE_DIR}/sponsors_lookup.json"
...
class MetricGenerators:
    ...
    def generate_corporate_era(commits):
        ...
        try:
             footprints = footprint.run_footprint_analysis("code/bitcoin", Config.MAINTAINERS_FILE, "data/core/maintainer_footprints.json")
